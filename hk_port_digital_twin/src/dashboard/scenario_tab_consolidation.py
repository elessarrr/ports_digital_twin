...
class ConsolidatedScenariosTab:
    ...
    def _initialize_session_state(self) -> None:
        ...
        # Check if default states have changed
        if 'last_default_states' not in st.session_state:
            st.session_state.last_default_states = self.default_states.copy()
            should_reinitialize = True
        elif st.session_state.last_default_states != self.default_states:
            st.session_state.last_default_states = self.default_states.copy()
            should_reinitialize = True
