...
from hk_port_digital_twin.utils.file_monitor import PortDataFileMonitor, create_default_port_monitor
...
from hk_port_digital_twin.utils.background_loader import BackgroundLoader
...
def load_combined_vessel_data() -> pd.DataFrame:
    ...
    try:
        ...
        # If a vessel appears in multiple datasets, prioritize arriving vessels to ensure they're visible
